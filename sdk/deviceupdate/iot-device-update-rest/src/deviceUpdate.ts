...
export interface Routes {
  ...
  /** Resource for '/deviceupdate/\{instanceId\}/management/deviceDiagnostics/logCollection' has methods for the following verbs: get */
  (
    path: "/deviceupdate/{instanceId}/management/deviceDiagnostics/logCollection",
    instanceId: string
